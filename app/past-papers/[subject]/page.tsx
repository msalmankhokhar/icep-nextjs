...
export async function generateStaticParams(): Promise<PageParams[]> {
  const subjectsObject = await getAllAdminSubjects();
          ...
          <div className="container mx-auto px-6 md:px-12">
            ...
            {papers.length > 0 ? (
              ...
              <div className="text-center py-12 bg-gray-50 rounded-lg border border-gray-200">
                <p className="text-brand-blue-400 mb-4">
          ...
          <div className="container mx-auto px-6 md:px-12">
            <div className="bg-white p-6 md:p-8 rounded-lg shadow-md border border-brand-blue-100">
              ...
              <div className="space-y-3 text-brand-blue-700">
                <p>
                  <strong>Focus on Fundamentals:</strong> Ensure you have a
                  solid understanding of core concepts and theories.
                </p>
                <p>
                  <strong>Analyze Question Patterns:</strong> Study past papers
                  to identify recurring themes and question formats.
                </p>
                <p>
                  <strong>Practice Answer Writing:</strong> Regular practice
                  helps improve your writing style, coherence, and time
                  management.
                </p>
                <p>
                  <strong>Stay Updated:</strong> Keep up with current events and
