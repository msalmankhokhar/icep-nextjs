...
export async function generateMetadata({
  ...
  return {
    title: `${magazine.title} - ICEP Magazines`,
    description: `Read ${magazine.title} from ${formatMonthName(
      magazine.month
    )} ${magazine.year}. Educational resources and insights from ICEP.`,
    keywords: `ICEP magazine, ${magazine.month} ${magazine.year}, educational resources, ${magazine.description}`,
  };
}
...
export default function MagazinePage({ params }: MagazinePageProps) {
  ...
  const cleanTitle = formatMagazineTitle(magazine.title + ".pdf");
  return (
    <>
      <Topbar />
      <Navbar />
              ...
              <nav className="text-sm mb-6">
                <ol className="flex items-center space-x-2 text-brand-blue-200">
                  <li>
                    <Link
                      href="/"
                      className="hover:text-brand-blue-100 transition-colors"
                    >
                      Home
                    </Link>
                  </li>
              ...
              <div className="flex flex-wrap items-center gap-4 mb-6">
                <div className="flex items-center bg-brand-blue-700 rounded-lg px-4 py-2">
                  ...
                  <span className="font-medium">
                    {formatMonthName(magazine.month)} {magazine.year}
                  </span>
                </div>
                ...
                {magazine.week && (
                  <div className="flex items-center bg-brand-blue-700 rounded-lg px-4 py-2">
                    <svg
                      className="w-5 h-5 mr-2 text-brand-yellow"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
        ...
        <section className="py-8 md:py-12 bg-brand-white">
          <div className="container mx-auto px-6 md:px-12">
            <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-brand-blue-100">
              ...
              <div className="p-6">
                <PDFViewerWrapper fileUrl={magazine.fileUrl} />
              </div>
            </div>
          </div>
        </section>{" "}
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border border-brand-blue-100">
              <div className="text-center">
                ...
                <p className="text-brand-blue-600 mb-6">
                  Discover other educational resources and stay updated with the
                  latest content.
                </p>
                <Link
                  href="/magazines"
