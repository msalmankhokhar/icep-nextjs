...
export const metadata = {
  ...
  description:
    "Access a comprehensive collection of CSS (Central Superior Services) past papers from all subjects. Download and practice with solved and unsolved papers to enhance your CSS preparation.",
};
      ...
      <main className="min-h-screen">
        ...
        <section className="bg-brand-blue text-white py-16 md:py-24">
          <div className="container mx-auto px-6 md:px-12">
            ...
            <p className="text-brand-blue-100 text-lg max-w-3xl">
              Access a comprehensive collection of CSS past papers from 2014 to
              2024. Practice with real exam questions to enhance your Central
              Superior Services preparation.
            </p>
          </div>
        </section>
        ...
        <section className="py-12 md:py-20 bg-brand-white">
          <div className="container mx-auto px-6 md:px-12">
            ...
            {adminSubjectObject.css.comp.length > 0 && (
              <div className="mb-16">
                ...
                <p className="text-brand-blue-600 mb-8">
                  All CSS candidates must appear in these 6 compulsory subjects
                  (100 marks each).
                </p>
            ...
            {adminSubjectObject.css.optional.length > 0 && (
              <div>
                <div className="flex items-center gap-3 mb-8">
                ...
                <p className="text-brand-blue-600 mb-8">
                  Choose 6 optional subjects from different groups (100 marks
                  each).
                </p>
          ...
          <div className="container mx-auto px-6 md:px-12">
            <div className="bg-white p-6 md:p-8 rounded-lg shadow-md border border-brand-blue-100">
              ...
              <div className="space-y-4 text-brand-blue-700">
                <p>
                  <strong>1. Understand the CSS Pattern:</strong> Review the CSS
                  exam structure, marking scheme (1200 marks written + 300
                  interview), and question formats.
                </p>
                <p>
                  <strong>2. Practice Subject-wise:</strong> Start with
                  compulsory subjects and then move to your chosen optional
                  subjects.
                </p>
                <p>
                  <strong>3. Time Management:</strong> CSS papers are 3 hours
                  each. Practice under timed conditions to improve speed.
                </p>
                <p>
                  <strong>4. Essay Writing:</strong> Pay special attention to
                  English Essay and Urdu Essay papers for writing skills.
                </p>
                <p>
                  <strong>5. Current Affairs:</strong> Focus on Pakistan Affairs
                  and Current Affairs for updated information and analysis.
                </p>
              </div>
              ...
              <div className="mt-6 p-4 bg-brand-yellow-50 border border-brand-yellow-200 rounded-md">
                <p className="text-brand-blue-800 font-medium">
                  Need structured CSS preparation? Join ICEP&apos;s
                  comprehensive CSS courses with expert mentorship and mock
                  tests.
                </p>
              </div>
            </div>
