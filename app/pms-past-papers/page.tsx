...
export const metadata = {
  ...
  description:
    "Access a comprehensive collection of PMS (Provincial Management Service) past papers from all subjects. Download and practice with solved and unsolved papers to enhance your PMS preparation.",
};
        ...
        <section className="bg-green-600 text-white py-16 md:py-24">
          <div className="container mx-auto px-6 md:px-12">
            ...
            <div className="flex items-center gap-2 text-green-200 mb-4">
              ...
              <span>/</span>
              <Link href="/past-papers" className="hover:text-green-100">
                Past Papers
              </Link>
              <span>/</span>
            ...
            <p className="text-green-100 text-lg max-w-3xl">
              Access a comprehensive collection of PMS past papers from recent
              years. Practice with real exam questions to enhance your
              Provincial Management Service preparation.
            </p>
          </div>
        </section>
          ...
          <div className="container mx-auto px-6 md:px-12">
            ...
            {subjectsObject.pms.comp.length > 0 ? (
              <div className="mb-16">
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <h2 className="text-3xl font-bold heading-font text-green-700">
                    Compulsory Subjects
                  </h2>
                  ...
                  {subjectsObject.pms.comp.map(async (subject, index) => {
                    ...
                    return (
                      <SubjectCard
                        ...
                        icon={
                          subjectIcons[subject.name] || <PiBookBookmarkBold />
                        }
                        count={paperCount}
                        index={index}
                      />
              ...
              <div className="mb-16">
                ...
                <div className="text-center py-12 bg-gray-50 rounded-lg border border-gray-200">
                  <p className="text-gray-500 mb-4">
                    PMS compulsory subjects papers are being organized.
                  </p>
                  <p className="text-sm text-gray-400">
                    Expected subjects: Urdu Essay & Composition, English Essay &
                    Composition, General Knowledge, Everyday Science
                  </p>
                </div>
              </div>
            )}
            ...
            {subjectsObject.pms.optional.length > 0 ? (
              <div>
                ...
                <p className="text-green-600 mb-8">
                  Choose from various optional subjects based on your background
                  and interest.
                </p>
              ...
              <div>
                ...
                <div className="text-center py-12 bg-gray-50 rounded-lg border border-gray-200">
                  <p className="text-gray-500 mb-4">
                    PMS optional subjects papers are being organized.
                  </p>
                  <p className="text-sm text-gray-400">
                    Expected subjects: Economics, Political Science, Public
                    Administration, History, Geography, Mathematics, Statistics,
                    and more
                  </p>
                </div>
              </div>
          ...
          <div className="container mx-auto px-6 md:px-12">
            <div className="bg-white p-6 md:p-8 rounded-lg shadow-md border border-green-100">
              ...
              <div className="space-y-4 text-green-600">
                <p>
                  <strong>1. Understand PMS Pattern:</strong> Review the PMS
                  exam structure, marking scheme, and provincial focus areas.
                </p>
                <p>
                  <strong>2. Focus on Provincial Context:</strong> PMS papers
                  often have questions specific to provincial administration and
                  local governance.
                </p>
                <p>
                  <strong>3. Practice Writing Skills:</strong> Both Urdu and
                  English composition are crucial for PMS success.
                </p>
                <p>
                  <strong>4. Current Affairs:</strong> Stay updated with both
                  national and provincial current affairs and developments.
                </p>
                <p>
                  <strong>5. Optional Strategy:</strong> Choose optional
                  subjects based on your academic background and scoring
                  potential.
                </p>
              </div>
              ...
              <div className="mt-6 p-4 bg-green-50 border border-green-200 rounded-md">
                <p className="text-green-800 font-medium">
                  Need structured PMS preparation? Join ICEP&apos;s
                  comprehensive PMS courses designed specifically for provincial
                  service success.
                </p>
              </div>
            </div>
